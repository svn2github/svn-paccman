 ...
 */
public class PaccmanuiView extends FrameView {

    /**
     * PAccMan main view.
     * @param app
     */
    public PaccmanuiView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = PaccmanuiApp.getApplication().getMainFrame();
            aboutBox = new PaccmanuiAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        PaccmanuiApp.getApplication().show(aboutBox);
    }
