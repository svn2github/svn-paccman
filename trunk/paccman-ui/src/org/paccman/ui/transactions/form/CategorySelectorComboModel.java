...
public class CategorySelectorComboModel extends DefaultComboBoxModel implements PaccmanView {
    ...
    private static final String TRANSFER_LIST_ELEM     = "Transfer"     ;
    private static final String SPLITPAYMENT_LIST_ELEM = "Split Payment";
    
    public static Object getTransferElement() {
        return TRANSFER_LIST_ELEM;
    }
    
    public static Object getSplitPaymentElement() {
        return SPLITPAYMENT_LIST_ELEM;
    }
    ...
    public void onChange(org.paccman.controller.Controller controller) {
        // Reset category list :TODO:optimize this according the controller 
        // which triggered the call
        removeAllElements();
        
        // Non actual "categories"
        addElement(NULL_LIST_ELEM          );
        addElement(TRANSFER_LIST_ELEM      );
        addElement(SPLITPAYMENT_LIST_ELEM);
