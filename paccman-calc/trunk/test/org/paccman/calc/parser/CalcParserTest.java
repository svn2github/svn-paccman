...
//        new TestData("1+2±=", new String[] {"1", "1", "2", "-2", "-1"}),
//        new TestData("1+2±±=", new String[] {"1", "1", "2", "-2", "2", "3"}),
//        new TestData("1+0±.±2=", new String[] {"1", "1", "0", "0", "0", "0", "0.2", "1.2"}),
//        new TestData("1+2=±*5=", new String[] {"1", "1", "2", "3", "-3", "-3", "5", "-15"}),
//        new TestData("1±+0.2±5=+3±=", new String[] {"1", "-1", "-1", "0", "0", "0.2", "-0.2", "-0.25", "-1.25", "-1.25","3", "-3", "-4.25"}),
